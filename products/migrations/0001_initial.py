# Generated by Django 3.2.18 on 2023-05-16 06:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bluetooth', models.BooleanField(choices=[(False, '유선'), (True, '무선')], default=False, verbose_name='유/무선')),
                ('switch', models.CharField(max_length=10)),
                ('pressure', models.IntegerField()),
                ('tenkey', models.BooleanField(choices=[(False, '풀배열'), (True, '텐키리스')], default=False, verbose_name='배열')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
