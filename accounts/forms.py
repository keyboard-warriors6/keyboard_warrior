...
class CustomUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs['class'] = 'signup-form block mt-6 px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none focus:ring-0 peer'
        self.fields['username'].widget.attrs['placeholder'] = " "
        self.fields['username'].label = '아이디'
        self.fields['username'].help_text = ''

        self.fields['last_name'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none focus:ring-0 peer'
        self.fields['last_name'].widget.attrs['placeholder'] = " "
        self.fields['last_name'].label = '성'
        self.fields['last_name'].help_text = ''

        self.fields['first_name'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none focus:ring-0 peer'
        self.fields['first_name'].widget.attrs['placeholder'] = " "
        self.fields['first_name'].label = '이름'
        self.fields['first_name'].help_text = ''

        self.fields['email'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none focus:ring-0 peer'
        ...
        self.fields['phone_number'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none focus:ring-0 peer'
        ...
        self.fields['password2'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none focus:ring-0 peer'
