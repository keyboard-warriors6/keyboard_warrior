...
class CustomUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['last_name'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none peer'
        self.fields['last_name'].widget.attrs['placeholder'] = " "
        self.fields['last_name'].label = '성'
        self.fields['last_name'].help_text = ''

        self.fields['first_name'].widget.attrs['class'] = 'signup-form block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white border-1 appearance-none peer'
